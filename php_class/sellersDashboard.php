...
<body>
  <div class="container"><br><br>
    <div class="row">
        <div class="col-4 mx-auto" id="color">
          <h3 class='text-center'>UPLOAD YOUR PRODUCT</h3>
          <form action="process_sellersDashboard.php" method="post" enctype="multipart/form-data">
           <!-- <?php
            ...
            <select name="product_category" class="form-control mb-3 bg-transparent" id="">
           ...
           <div>
           <input type="submit" name='submit' id='button' class='btn btn-success btn-sm' value='submit'>
            <a href="./seller_product.php" style='text-decoration:none;'>
