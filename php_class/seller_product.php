                ...
                if ($queryDb->num_rows > 0) {
                    while ($all = $queryDb->fetch_assoc ()) {
                        ...
                        <div class='card p-2'><img src='uploads/{$all['image']}' style='height:25vh;' alt=''>
                            <div class='h5 '>Product: {$all['product_name']}</div>
                            <div class='h5 fw-bold'>{$all['price']}</div>
                            <div class='h5  text-dark'>Quantity: {$all['quantity']}</div>
                          <div class='h5  text-dark'>Details: {$all['details']}</div>
                            </div>
                    </div>"
                    ; 
                    }
